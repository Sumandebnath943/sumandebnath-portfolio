  ...
  return (
    <MotionProvider>
      ...
      <main className="ct">
          ...
          <div className="ct-shell">
            ...
            <div className="ct-doors">
              <a
                ...
                className="ct-door ct-door--wa"
              >
                <span className="ct-door-k">
                ...
                <span className="ct-door-v">{identity.phone}</span>
                <span className="ct-door-n">Usually the fastest way through.</span>
              </a>

              <a href={`mailto:${identity.email}`} className="ct-door ct-door--mail">
                <span className="ct-door-k">Email</span>
                <span className="ct-door-v">{identity.email}</span>
                <span className="ct-door-n">For anything with an attachment.</span>
              </a>

              <a href={identity.phoneHref} className="ct-door ct-door--call">
                <span className="ct-door-k">Call</span>
                <span className="ct-door-v">{identity.phone}</span>
                <span className="ct-door-n">If it is genuinely urgent.</span>
              </a>
            </div>
          </div>
        </header>
        ...
        <section id="tour-contact-form" className="ct-body">
          <div className="ct-shell">
            <p className="ct-eyebrow">Or write it here</p>
            <h2 className="ct-h2">
            ...
            <div className="ct-grid">
              ...
              <aside className="ct-rail">
                <div>
                  <p className="ct-fact-k">Based in</p>
                  <p className="ct-fact-v">
                    {identity.location}
                    <br />
                ...
                <div>
                  <p className="ct-fact-k">Availability</p>
                  <p className="ct-fact-v">
                    Open to senior roles.
                    <br />
                ...
                <div>
                  <p className="ct-fact-k">Response time</p>
                  <p className="ct-fact-v">
                ...
                <div>
                  <p className="ct-fact-k">Elsewhere</p>
                  <p className="ct-fact-v">
                    {SOCIALS.map((s, i) => (
                      <span key={s.label}>
                        {i > 0 && " · "}
        ...
        <section className="ct-body" style={{ paddingTop: 0 }}>
          <div className="ct-shell">
            <p className="ct-eyebrow">If you&apos;re hiring</p>
            <h2 className="ct-h2">The roles worth a conversation</h2>
            <ul className="ct-roles">
              {targetRoles.map((role) => (
                <li key={role}>{role}</li>
              ))}
            </ul>
            <p className="ct-fact-v" style={{ maxWidth: "62ch", marginTop: "1.75rem" }}>
            ...
            <p className="ct-eyebrow" style={{ marginTop: "3rem" }}>
            ...
            <div className="ct-cards">
              {[
                ...
                <Link key={card.href} href={card.href} className="ct-card">
                  <span className="ct-card-t">
                    {card.title}
                    <span aria-hidden>→</span>
                  </span>
                  <span className="ct-card-d">{card.body}</span>
                </Link>
              ))}
            </div>

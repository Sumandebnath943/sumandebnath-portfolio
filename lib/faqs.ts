...
export const aboutFaqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Suman’s core expertise spans branding, brand management, digital marketing, growth systems, SEO, answer engine optimisation (AEO), generative engine optimisation (GEO), agentic readiness, AI agent orchestration, multi-agent systems, paid advertising, creative direction, design systems, campaign architecture, automation workflows, AI-native execution systems, operational strategy, and AI-assisted product development.",
  },
  {

...
const projects: ProjectData[] = [
  {
    ...
    number: "01",
    title: "Migi",
    positioning: "A personal suite of 20+ autonomous AI agents.",
    ...
    capabilities: ["20+ Autonomous Agents", "GitHub Actions Orchestration", "Secure 2FA Dashboard"],
    ...
    coverImage: "/migi-agent/dashboard.png",
    theme: {

...
// ── CAPABILITIES DATA ──
const capabilities = [
  { title: "Sarcastic Terminal Gateway", desc: "Landing page responds to standard dev commands with highly specific, condescending jokes." },
  { title: "Socratic Interview Engine", desc: "A chat interface that guides the user through a 4-step interview to build the prompt contextually." },
  { title: "Reverse Engineer Mode", desc: "Users can paste any AI output, and the engine will reverse-engineer the exact prompt." },
  { title: "RAG Document Grounding", desc: "Upload PDFs/docs, embed and index them locally to ground prompt generation." },
  { title: "Advanced Tournament Mode", desc: "Runs a 'best-of-N' tournament behind the scenes, testing prompt candidates." },
  { title: "Session Memory", desc: "Remembers the user's style and previous interactions to avoid repeating instructions." },
];

export default function DPeDossier() {
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-[0.02] pointer-events-none mix-blend-screen overflow-hidden">
        <m.div 
          ...
          style={{
            background: 'conic-gradient(from 0deg, transparent 0deg, transparent 270deg, #3fb950 360deg)'
          }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 md:py-28">
        ...
        >
          <div className="px-4 py-2 border border-[#3fb950]/20 rounded bg-[#3fb950]/[0.02] backdrop-blur-md flex items-center gap-3">
            <div className="w-1.5 h-1.5 rounded-full bg-[#3fb950] animate-pulse" />
            <p className="font-mono text-[10px] text-[#3fb950] uppercase tracking-[0.5em] ml-[0.5em]">
        ...
        >
          <div className="relative flex flex-col items-center group">
            ...
            {!logoError ? (
              <div className="relative w-full max-w-[480px] md:max-w-[700px] h-48 md:h-64 mb-8 z-10 mix-blend-screen">
                <Image 
                  src="/tools/D-PE.ai_v2.png" 
                  alt="D-PE.ai — God-Tier Prompt Engineering by Suman Debnath, with market surveillance, entity extraction, and knowledge graphs"
                  fill 
          ...
          <p className="font-manrope text-lg md:text-xl text-[#86868B] max-w-2xl mx-auto leading-relaxed">
            A premium, developer-focused workspace that transforms raw ideas into structured, robust AI prompts.
          </p>
        </m.div>
        ...
        >
          ...
          <p className="font-manrope text-base md:text-lg text-[#86868B] leading-relaxed mb-8">
            ...
            D-PE.ai acts as an interviewer.
          </p>
          <p className="font-manrope text-base md:text-lg text-[#86868B] leading-relaxed">
            It asks probing questions to extract missing constraints, edge cases, and formatting rules.<br />
            <span className="text-white mt-4 block">And then it generates the ultimate prompt.”</span>
          </p>
        </m.div>
        ...
        >
          {/* Edge Glow */}
          <div className="absolute -inset-1 bg-gradient-to-b from-[#3fb950]/20 via-[#238636]/10 to-transparent rounded-3xl blur-2xl opacity-50 transition-opacity duration-1000 group-hover:opacity-100" />
          
          <m.div 
            style={{ y }} 
            className="relative rounded-2xl overflow-hidden bg-[#0A0D18] border border-[#3fb950]/15 shadow-[0_40px_100px_rgba(0,0,0,0.9)]"
          >
            {/* Cinematic Tactical Chrome */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#3fb950]/10 bg-[#080B14]">
              <div className="flex gap-4 opacity-40">
                {/* Tactical scanner bars instead of macOS dots */}
                <div className="w-4 h-1 bg-[#3fb950]" />
                <div className="w-4 h-1 bg-[#3fb950]" />
                <div className="w-4 h-1 bg-[#238636]" />
              </div>
              <div className="flex items-center gap-3 px-6 py-1.5 rounded-sm bg-[#3fb950]/[0.02] border border-[#3fb950]/10">
                <span className="text-[10px] font-mono text-[#3fb950]/60 tracking-widest">
                  https://D-PE.ai.houseofnamus.com
                </span>
              </div>
            ...
            <div className="relative h-[500px] md:h-[700px] overflow-hidden bg-[#05070D]">
              ...
              <div className="h-full overflow-y-auto no-scrollbar scroll-smooth">
                ...
                <div className="relative w-full">
                  ...
                  <Image 
                    src="/screenshots/d-pe.png"
                    alt="D-PE.ai product interface — career pivot translator, job security radar, and unified tactical command center"
                    width={1920}
                    height={4000}
        ...
        <div className="mb-16">
          <m.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
            className="mb-12 border-b border-[#3fb950]/10 pb-6"
          >
            <p className="font-mono text-[10px] text-[#3fb950] uppercase tracking-[0.3em] mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {capabilities.map((cap, i) => (
              <m.div
                ...
                className="group relative p-6 bg-[#3fb950]/[0.02] border border-[#3fb950]/10 hover:border-[#238636]/40 hover:bg-[#238636]/[0.03] transition-colors duration-500 cursor-default"
              >
                {/* Tactical corner accents */}
                <div className="absolute top-0 left-0 w-2 h-[1px] bg-[#3fb950]/50 group-hover:bg-[#238636] transition-colors duration-500" />
                <div className="absolute top-0 left-0 w-[1px] h-2 bg-[#3fb950]/50 group-hover:bg-[#238636] transition-colors duration-500" />
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[1px] bg-[#3fb950]/10 pointer-events-none" />
          <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-[1px] bg-[#3fb950]/10 pointer-events-none" />

          <h2 className="font-serif italic text-4xl md:text-5xl lg:text-7xl text-white leading-tight relative z-10">
            “Stop writing mid prompts.
            <br />
            <span className="text-[#3fb950]">Start engineering them.</span>”
          </h2>
        </m.div>

        <DossierMeta slug="D-PE.ai" />
      </div>
    </div>
  );
}

...
const commands: Command[] = [
  ...
  },
  {
    ...
    command: "/resume",
    label: "Résumé",
    description: "The full résumé on one page — experience, every product, education, PDF download",
    href: "/resume",
    icon: "▤",
  },
  {
    ...
    command: "/about",
    label: "About",
    description: "How a decade of brand marketing became AI product building",
    href: "/about",
    icon: "◉",
  },
  {
    id: "philosophy-page",
    command: "/philosophy-page",
    label: "Philosophy (full page)",
    description: "The long-form operating principles, beyond the homepage summary",
    href: "/philosophy",
    icon: "◈",
  },
  {
  ...
  },
  {
    ...
    command: "/fun",
    label: "Fun Apps",
    description: "Experiments and toys, including Soul Canvas",
    href: "/fun-apps",
    icon: "✷",
  },
  {
    // Was "#contact", the homepage closing strip — which shows an email address
    // but has no way to actually send anything.
    id: "contact",
    command: "/contact",
    label: "Get In Touch",
    description: "Contact form, email, phone, and current availability",
    href: "/contact",
    icon: "→",
  },
  {
    ...
    command: "/privacy",
    label: "Privacy",
    description: "What this site records, and how to switch it off",
    href: "/privacy",
    icon: "⚿",
  },
];

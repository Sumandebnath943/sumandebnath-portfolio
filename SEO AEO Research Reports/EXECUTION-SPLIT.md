...
| A4 ← P2-1 | **LinkedIn + profile headlines**: site now points to the main identity account `/in/suman-debnath-a528653a1` (the `/in/houseofnamus` stealth account is excluded). Optionally clean that account's vanity URL to a name-based one; set the **identical** headline/bio on LinkedIn, GitHub, X. | I can't log into your social accounts. |
